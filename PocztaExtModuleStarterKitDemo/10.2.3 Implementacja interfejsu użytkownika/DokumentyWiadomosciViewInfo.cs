...
using PocztaExtModuleStarterKitDemo._10._2._3_Implementacja_interfejsu_użytkownika;
...
namespace PocztaExtModuleStarterKitDemo._10._2._3_Implementacja_interfejsu_użytkownika
{
    public class DokumentyWiadomosciViewInfo : ViewInfo
    {
        ...
        private void DokumentyWiadomosciViewInfo_InitContext(object sender,
       ContextEventArgs args)
        {
            args.Context.TryAdd(() => new DokumentyWiadomosciParams(args.Context));
        }
        private void DokumentyWiadomosciViewInfo_CreateView(object sender,
       CreateViewEventArgs args)
        {
        ...
        private View PrepareView(DokumentyWiadomosciParams @params)
        {
            ...
            return
           HandelModule.GetInstance(@params).DokHandlowe.WgDefinicja[@params.Definicja][cond].CreateView();
        }
    }
}