...
[assembly: ModuleType("PocztaExt", typeof(enova365.PocztaExt.PocztaExtModule), 4, "PocztaExt", 2, VersionNumber=100)]

namespace enova365.PocztaExt {
	...
	/// <seealso cref="PocztaExtModuleStarterKitDemo.businessObjectsRepresentationClasses"/>
	/// </summary>
	...
	public partial class PocztaExtModule : Module {
		...
		public static readonly Soneta.Business.App.TableInfo WiadomosciExtTableInfo = new Soneta.Business.App.TableInfo.Create<WiadomosciExt, WiadomoscExt, WiadomoscExtRecord>("Wiadomos") {
		};

		public WiadomosciExt WiadomosciExt => (WiadomosciExt)Session.Tables[WiadomosciExtTableInfo];

		private static Soneta.Business.App.KeyInfo keyInfoWiadomoscExtWiadomosc = new Soneta.Business.App.KeyInfo(WiadomosciExtTableInfo, table => new WiadomoscExtTable.WiadomoscRelation(table)) {
			Name = "Dokumenty związane z wiadomością",
			RelationTo = "WiadomoscEmail",
			KeyFields = new[] {"Wiadomosc", "ID"},
		};

		private static Soneta.Business.App.KeyInfo keyInfoWiadomoscExtDokument = new Soneta.Business.App.KeyInfo(WiadomosciExtTableInfo, table => new WiadomoscExtTable.DokumentRelation(table)) {
			Name = "Powiązanie dokumentu z wiadomosciąEmail",
			RelationTo = "DokumentHandlowy",
			KeyFields = new[] {"Dokument", "ID"},
		};

		private static Soneta.Business.App.KeyInfo keyInfoWiadomoscExtWgWiadomoscDokument = new Soneta.Business.App.KeyInfo(WiadomosciExtTableInfo, table => new WiadomoscExtTable.WgWiadomoscDokumentKey(table)) {
		...
		public abstract partial class WiadomoscExtTable : GuidedTable {
			...
			public partial class WiadomoscRelation : Key<WiadomoscExt> {
			...
			public partial class DokumentRelation : Key<WiadomoscExt> {
			...
			public partial class WgWiadomoscDokumentKey : Key<WiadomoscExt> {
			...
			public System.Linq.IQueryable<WiadomoscExt> AsQuery() => AsQuery<WiadomoscExt>();
		...
		public abstract partial class WiadomoscExtRow : GuidedRow {
			...
			protected override Soneta.Business.App.TableInfo TableInfo => WiadomosciExtTableInfo;
		...
		public static readonly Soneta.Business.App.TableInfo WydrukiWiadTableInfo = new Soneta.Business.App.TableInfo.Create<WydrukiWiad, WydrukWiadomosci, WydrukWiadomosciRecord>("WydrukWi") {
		};

		public WydrukiWiad WydrukiWiad => (WydrukiWiad)Session.Tables[WydrukiWiadTableInfo];

		private static Soneta.Business.App.KeyInfo keyInfoWydrukWiadomosciDefinicja = new Soneta.Business.App.KeyInfo(WydrukiWiadTableInfo, table => new WydrukWiadomosciTable.DefinicjaRelation(table)) {
			Name = "Relacja pola Definicja",
			RelationTo = "DefDokHandlowego",
			KeyFields = new[] {"Definicja", "ID"},
		};

		private static Soneta.Business.App.KeyInfo keyInfoWydrukWiadomosciOperator = new Soneta.Business.App.KeyInfo(WydrukiWiadTableInfo, table => new WydrukWiadomosciTable.OperatorRelation(table)) {
			Name = "Relacja pola Operator",
			RelationTo = "Operator",
			KeyFields = new[] {"Operator", "ID"},
		};

		private static Soneta.Business.App.KeyInfo keyInfoWydrukWiadomosciWgDefinicjaOperator = new Soneta.Business.App.KeyInfo(WydrukiWiadTableInfo, table => new WydrukWiadomosciTable.WgDefinicjaOperatorKey(table)) {
		...
		public abstract partial class WydrukWiadomosciTable : GuidedTable {
			...
			public partial class DefinicjaRelation : Key<WydrukWiadomosci> {
			...
			public partial class OperatorRelation : Key<WydrukWiadomosci> {
			...
			public partial class WgDefinicjaOperatorKey : Key<WydrukWiadomosci> {
			...
			public System.Linq.IQueryable<WydrukWiadomosci> AsQuery() => AsQuery<WydrukWiadomosci>();
		...
		public abstract partial class WydrukWiadomosciRow : GuidedRow {
			...
			protected override Soneta.Business.App.TableInfo TableInfo => WydrukiWiadTableInfo;
	...
	public static class StaticsPocztaExtModule {
		...
		public static TResult Record<TResult>(this IRecordInvoker<WiadomoscExt, TResult> row, Action<PocztaExtModule.WiadomoscExtRecord> action)
		    => row.InvokeAction(action, (rec, act) => ((Action<PocztaExtModule.WiadomoscExtRecord>)act)((PocztaExtModule.WiadomoscExtRecord)rec));

		public static TResult Record<TResult>(this IRecordInvoker<WydrukWiadomosci, TResult> row, Action<PocztaExtModule.WydrukWiadomosciRecord> action)
		    => row.InvokeAction(action, (rec, act) => ((Action<PocztaExtModule.WydrukWiadomosciRecord>)act)((PocztaExtModule.WydrukWiadomosciRecord)rec));
	}
